...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
       String domainName= fullyQualifiedTable.getDomainObjectName();
        ...
        setDeleteByPrimaryKeyStatementId("delete"+domainName
                + "ById"); //$NON-NLS-1$
        setInsertStatementId("insert"+domainName); //$NON-NLS-1$
        setInsertSelectiveStatementId("insert"
                + "Selective"+domainName); //$NON-NLS-1$
        setSelectAllStatementId("selectAll"); //$NON-NLS-1$
        setSelectByExampleStatementId("selectByExample"); //$NON-NLS-1$
        setSelectByExampleWithBLOBsStatementId("selectByExampleWithBLOBs"); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId("get"+domainName
                + "ById"); //$NON-NLS-1$
        ...
        setUpdateByPrimaryKeyStatementId("update"+domainName
                + "ById"); //$NON-NLS-1$
        setUpdateByPrimaryKeySelectiveStatementId("updateSelective"+domainName
                + "ById"); //$NON-NLS-1$
        setUpdateByPrimaryKeyWithBLOBsStatementId("updateByPrimaryKeyWithBLOBs"); //$NON-NLS-1$
        setBaseResultMapId(domainName+"_BaseResultMap"); //$NON-NLS-1$
        setResultMapWithBLOBsId("ResultMapWithBLOBs"); //$NON-NLS-1$
        setExampleWhereClauseId("Example_Where_Clause"); //$NON-NLS-1$
        setBaseColumnListId(domainName+"_Base_Column_List"); //$NON-NLS-1$
        setBlobColumnListId("Blob_Column_List"); //$NON-NLS-1$
        setMyBatis3UpdateByExampleWhereClauseId("Update_By_Example_Where_Clause"); //$NON-NLS-1$
        setIdNextValue("get"+domainName+"IdNextVal");
    }

    //设置生成nextval的方法名
    public void setIdNextValue(String id){
        
        internalAttributes.put(InternalAttribute.ID_SEQ_NEXTVAL, id);
    }
    public String getIdNextValue(){
        return internalAttributes.get(InternalAttribute.ID_SEQ_NEXTVAL);
    }
