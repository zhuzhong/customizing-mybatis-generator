...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.OracleSeqNextValElementGererator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        addGetIdNextValueElement(answer);
    ...
    //增加获取每个表的相应的sequence的nextval 方法,对于member增加 getMemberIdNextval()方法
    protected void addGetIdNextValueElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new OracleSeqNextValElementGererator();
